 ...
 */
public class ShowVisitCollectedDataAdapter extends RecyclerView.Adapter<ShowVisitCollectedDataAdapter.CoreCollectedDataViewHolder> {
    ...
    public ShowVisitCollectedDataAdapter(Context context, CoreCollectedDataItem[] objects, OnItemActionListener listener){
        this.collectedDataList = new ArrayList<>();
    ...
    public void setCheckedOrUnchecked(int position) {
        ...
        if (collectedDataList.get(position).collectedData.uploaded==false || collectedDataList.get(position).collectedData.uploadedWithError) {
    ...
    public CoreCollectedDataViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        View rowView = inflater.inflate(R.layout.core_form_visit_item, parent, false);
    ...
    class CoreCollectedDataViewHolder extends RecyclerView.ViewHolder {
        ...
        public void setValues(CoreCollectedDataItem dataItem) {
            ...
            button.setOnClickListener(v -> {
                if (listener != null) {
                    listener.onInfoButtonClicked(dataItem);
                }
            });
