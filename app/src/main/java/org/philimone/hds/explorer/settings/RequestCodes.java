package org.philimone.hds.explorer.settings;

public class RequestCodes {

    public static final int REGION_DETAILS_FROM_TRACKING_LIST_DETAILS = 20;
    ...
    public static final int SCAN_BARCODE = 100;
